      ...
      {({open}) => (
              ...
              <div className="flex items-center">
                <Link href="/">
                  <h1 className="text-2xl font-medium">
                    Ryan <span className="text-teal-500">Nishimoto</span>
                  </h1>
                </Link>
              </div>
        ...
        <Disclosure.Panel className="sm:hidden">
          <div className="pt-2 pb-3 space-y-1">
            ...
            : 'border-transparent text-gray-500 hover:bg-50 hover:border-gray-300 hover:text-teal-500 block pl-3 pr-4 py-2 dark:hover:bg-gray-700 border-l-4 text-base font-medium dark:text-white'}`}>
              Home
            </Link>
